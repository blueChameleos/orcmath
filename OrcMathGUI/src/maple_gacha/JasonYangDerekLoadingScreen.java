...
public class JasonYangDerekLoadingScreen extends FullFunctionScreen {
	...
	private JasonYDerekCustomButtonFront newgame;
	private TextArea name;
	private TextArea newgametext;
	private TextArea quittext;
	
	public JasonYangDerekLoadingScreen(int width, int height) {
		super(width, height);
	}
	...
	public void initAllObjects(List<Visible> viewObjects) {
		...
		newgame = new JasonYDerekCustomButtonFront(getWidth() / 2 - 100, 462, 200, 75);
		...
		quit = new JasonYDerekCustomButtonFront(1000, 900, 200, 50);
