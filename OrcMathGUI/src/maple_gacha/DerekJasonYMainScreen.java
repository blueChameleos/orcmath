...
public class DerekJasonYMainScreen extends WeiLightingScreen {
	/**
	 * 
	 */
	...
	private JasonYDerekCustomButtonFront dungeon;
	private JasonYDerekCustomButtonFront summonb;
	private JasonYDerekCustomButtonFront inventory;
	private JasonYDerekCustomButtonFront quit;
	...
	public DerekJasonYMainScreen(int width, int height) {
		super(width, height);
	}
	public void initAllObjects(List<Visible> viewObjects) {		
		...
		dungeon = new JasonYDerekCustomButtonFront((getWidth()/4)-50,875,200,100);
		...
		summonb = new JasonYDerekCustomButtonFront(getWidth()/2-100,875,200,100);
	...
	//			MainGame.playMusic("resources/everythingelse.wav");	
		...
		inventory = new JasonYDerekCustomButtonFront(((getWidth()/4)*3)-150,875,200,100);
		...
		quit = new JasonYDerekCustomButtonFront(getWidth()-175,getHeight()-100,150,75);
