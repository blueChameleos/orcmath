...
public class EthanSummonScreen extends FullFunctionScreen implements Runnable, BannerInterface {
	...
	public void initAllObjects(List<Visible> viewObjects) {
		...
		count = new TextArea((int) (getWidth() / 10 * 2.5), (int) (getHeight() / 2 * .525), 500, 500,
				"  " + getNx() + " NX");
		count.setText("  " + nx + " NX");
		...
		Graphic banner = new Graphic(BANNER_WIDTH, BANNER_HEIGHT, 650, 350, "resources/banner.jpg");
		add(banner);

		Graphic banner1 = new Graphic(BANNER_WIDTH, BANNER_HEIGHT, 650, 350, "resources/banner1.jpg");
		add(banner1);
		...
		ClickableGraphic leftArrow = new ClickableGraphic((int) (getWidth() / 10 * .75), (int) (getHeight() / 2 * .80),
				178, 179, "resources/picture1.png");
		...
		ClickableGraphic rightArrow = new ClickableGraphic((int) (getWidth() / 10 * 7.75),
				(int) (getHeight() / 2 * .80), 178, 179, "resources/picture2.png");
		...
		Button single = new Button((int) (getWidth() / 10 * 3.75), (int) (getHeight() / 2 * 1.4), 50, 50, "x1",
				Color.yellow, new Action() {
					@Override
					public void act() {
						if (canSummon(0)) {
							// 0 = single summon
		...
		Button multi = new Button(getWidth() / 10 * 6, (int) (getHeight() / 2 * 1.4), 50, 50, "x5", Color.yellow,
				new Action() {
		...
		Button feature = new Button((int) (getWidth() / 2 * 1.36), (int) (getHeight() / 2 * .51), 100, 75, "featured",
				Color.yellow, new Action() {
		...
		Button mainMenu = new Button((int) (getWidth() / 10 * 4.75), (int) (getHeight() / 2 * 1.5), 100, 75,
				"Main Menu", Color.yellow, new Action() {
